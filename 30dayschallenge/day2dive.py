...
file = open(r'C:\Users\lab\Desktop\testgit\pythonpractice\30dayschallenge\day2input.txt')
lines = file.read()
y = lines.split(sep='\n')
file.close()
...
for i in y:
    ...
    if splitword[0] == 'forward':
        horizontalposition = horizontalposition + int(splitword[1])
    elif splitword[0] == 'down':
        depth = depth + int(splitword[1])
    elif splitword[0] == 'up':
        depth = depth - int(splitword[1])
...
#  have after following the planned course. What do you get if you multiply your final horizontal position 
#  by your final depth?
...
for i in y:
    ...
    if splitword[0] == 'forward':
        horizontalposition = horizontalposition + int(splitword[1])
        depth = depth + (aim * int(splitword[1]))
    elif splitword[0] == 'down':
        aim = aim + int(splitword[1])
    elif splitword[0] == 'up':
        aim = aim - int(splitword[1])
